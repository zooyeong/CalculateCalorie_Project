...
public class BoardDao {
	...
	public int insertBoard(String content_text, String content_img) {
		...
		try {
			...
			// 쿼리문!
			String sql = "insert into board(user_id, title, content_text, content_img)"
						+" values('123', 'haha', ?, ?)";

			psmt = conn.prepareStatement(sql);
			psmt.setString(1, content_text);
			psmt.setString(2, content_img);
