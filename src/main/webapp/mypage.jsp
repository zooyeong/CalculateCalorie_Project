...
h1{font-family: 'omyu_pretty';}
</style>
</head>
<body>
<%@ include file = "tempMain.jsp" %>
<%
...
%>
			<div id="container">			
				<form name='pwChangeForm' action='pwChange_proc.jsp' method='post'>
					...
					<input type="text" name="inputBirth" value="<%=memberDto.getBirth() %>" disabled><br>
					<label for="inputGender">성별</label>
					<input type="text" name="inputGender" value="<%=memberDto.getGender() %>" disabled><br>
					<label for="inputEmail">이메일</label>
					<input type="text" name="inputEmail" value="<%=memberDto.getEmail() %>" disabled><br>
